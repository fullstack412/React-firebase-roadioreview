...
const MapContainer = compose(
  ...
  lifecycle({
    ...
    { 
        ...
        if (this.props.isFormMap && this.props.isNewForm) {
          
          if (this.state.placeName !== nextState.placeName) {
            return true;
          }
          ...
          if (this.state.editedFromDB !== nextState.editedFromDB) {
            return true;
          }

          // if (this.state.currentPlace !== nextState.currentPlace) {
          //   return true;
          // }
          ...
          if (this.state.locationFromDB !== nextState.locationFromDB) {
            return true;
          }

          if (this.state.editedChecker !== nextState.editedChecker) {
            return true;
          }

          if (this.state.isMap !== nextState.isMap) {
            return true;
          }

          if (this.state.btnC !== nextState.btnC) {
            return true;
          }

          if (this.state.btnG !== nextState.btnG) {
            return true;
          }

          if (this.state.inputC !== nextState.inputC) {
            return true;
          }

          if (this.state.inputG !== nextState.inputG) {
            return true;
          }

          if (this.state.updatedFromPost !== nextState.updatedFromPost) {
            return true;
          }
